...
internal class CreateBusinessEventOnBusinessCreatedDomainEventHandler : IDomainEventHandler<EntityInsertedEvent<Business>>
{
    private readonly IBaseRepository<Event> _eventRepository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly IAuthService _authService;

    private DateTime _triggerTimeToValidateDocument => DateTime.Now.AddMinutes(5);

    public CreateBusinessEventOnBusinessCreatedDomainEventHandler( 
