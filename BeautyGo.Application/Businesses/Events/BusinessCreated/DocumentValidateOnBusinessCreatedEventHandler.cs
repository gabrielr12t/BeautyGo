...
internal class DocumentValidateOnBusinessCreatedEventHandler : IEventHandler<BusinessCreatedEvent>
{
    #region Fields
    ...
    public DocumentValidateOnBusinessCreatedEventHandler(IReceitaFederalIntegrationService receitaFederalIntegration, IBaseRepository<Business> businessRepository)
    {
