...
internal class SendValidateDocumentEmailOnBusinessCreatedIntegrationEventHandler : IIntegrationEventHandler<BusinessCreatedIntegrationEvent>
{
    ...
    public SendValidateDocumentEmailOnBusinessCreatedIntegrationEventHandler(
