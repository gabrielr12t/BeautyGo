...
using BeautyGo.Infrasctructure.Services.Authentication;
using BeautyGo.Infrasctructure.Services.Authentication.Events;
using BeautyGo.Infrasctructure.Services.Cryptography;
using BeautyGo.Infrasctructure.Services.Installation;
using BeautyGo.Infrasctructure.Services.Logging;
using BeautyGo.Infrasctructure.Services.Security;
using BeautyGo.Infrasctructure.Services.Business;
using BeautyGo.Infrasctructure.Services.Users;
using BeautyGo.Infrasctructure.Services.Web;
