...
namespace BeautyGo.Persistence.Migrations
{
    ...
    [Migration("20250209055839_InitialDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeautyGo.Domain.Entities.Stores.Store", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BeautyGo.Domain.Entities.Stores.StorePicture", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("StoreId", "PictureId")
                        .IsUnique();

                    b.ToTable("StorePicturies", "Store");
                });
            ...
            modelBuilder.Entity("BeautyGo.Domain.Entities.Stores.StoreEmailTokenValidation", b =>
                {
            ...
            modelBuilder.Entity("BeautyGo.Domain.Entities.Stores.StorePicture", b =>
                {
                    ...
                    b.HasOne("BeautyGo.Domain.Entities.Stores.Store", "Store")
                        .WithMany("Pictures")
