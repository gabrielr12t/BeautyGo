...
namespace BeautyGo.Persistence.Migrations
{
    ...
    [Migration("20250501040755_CreateBusinessCalculateDistance")]
    partial class CreateBusinessCalculateDistance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeautyGo.Domain.Entities.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BeautyGo.Domain.Entities.Outbox.OutboxMessageError", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OutboxMessageError", (string)null);
                });
            ...
            modelBuilder.Entity("BeautyGo.Domain.Entities.Professionals.ProfessionalRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProfessionalRequests", "Businesses");
                });
            ...
            modelBuilder.Entity("BeautyGo.Domain.Entities.Users.UserAddressMapping", b =>
                {
                    ...
                    b.ToTable("UsersAddresses", "Users");
                });
            ...
            modelBuilder.Entity("BeautyGo.Domain.Entities.Outbox.OutboxMessageError", b =>
                {
                    b.HasOne("BeautyGo.Domain.Entities.Outbox.OutboxMessage", "OutboxMessage")
                        .WithMany("Errors")
