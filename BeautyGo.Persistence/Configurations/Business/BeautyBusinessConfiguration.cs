...
internal class BeautyBusinessConfiguration : BaseEntityConfiguration<BeautyBusiness>
{
    public override void Configure(EntityTypeBuilder<BeautyBusiness> builder)
    {
        base.Configure(builder);

        builder.ToTable("BeautyBusiness", "Business");
